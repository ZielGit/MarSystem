...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-3">{{ __('Edit Provider') }} </h4>
            ...
            <form action="{{ route('providers.update', $provider) }}" method="post">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="number" class="form-control" name="ruc" id="ruc" value="{{ old('ruc', $provider->ruc) }}">
                        @error('ruc')
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="email" class="form-control" name="email" id="email" value="{{ old('email', $provider->email) }}" aria-describedby="emailHelp">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="tel" class="form-control" name="phone" id="phone" value="{{ old('phone', $provider->phone) }}"  aria-describedby="phoneHelp">
